...
> O Sistema de Jogo gera aleatoriamente um único nº secreto de 4 bit;
  
> existem dois jogadores (J1 e J2) idênticos, os quais palpitam sobre o nº secreto gerado pelo sistema;

> o sistema dá um certo tempo para os jogadores inserirem os seus palpites, após o que verifica o resultado;

> o jogo desenrola-se em mãos que podem ir de 1 a 15 jogos;

> existem dois mostradores numéricos que indicam quantos acertos e falhas houve numa mão;

> no final de cada mão acende-se um led indicador, bem como um de três leds que indica o resultado dessa mão, conforme a tabela abaixo; nessa altura o jogo fica bloqueado devendo carregar-se num botão “recomeço” para passar a outra mão;

> existe uma entrada para selecionar o modo de jogo.
</td>
</tr>
</table>
...
Após a entrega deste projeto ficará publico :  https://github.com/tiago-barreiros/LogiJogo
...
- [Assembly](https://www.ime.usp.br/~jstern/software/asm/)
...
## [Prof. Doutor Pedro Araújo](https://www.it.pt/Members/Index/1448)

## *Tecnologia de Computadores* @[Universidade da Beira Interior](https://www.ubi.pt/).
